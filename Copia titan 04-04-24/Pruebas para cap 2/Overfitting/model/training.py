...
def getMeanStd():
    ...
    dataset = CustomDataset('./dataset_conceptual_captions_lite.npy')
    print(len(dataset))
    dataloader = DataLoader(dataset, batch_size=len(dataset), shuffle=True, num_workers=1, drop_last=False)
